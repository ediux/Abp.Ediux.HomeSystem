...
namespace Ediux.HomeSystem.Web.Pages.Components.WelcomeWidget
{
    ...
    public class WelcomeWidgetViewComponent : AbpViewComponent
    {
        ...
        {
            return View("~/Components/Widgets/WelcomeWidget/Default.cshtml", new SystemSettingsDTO() { WelcomeSlogan = (await settingManagementAppService.GetOrNullGlobalAsync(HomeSystemSettings.WelcomeSlogan)) ?? string.Empty });
        }
    }
}
