$(function () {
    ...
    var createModal = new abp.ModalManager(abp.appPath + "CmsKit/Admins/Tags/CreateModal");
    var updateModal = new abp.ModalManager(abp.appPath + "CmsKit/Admins/Tags/EditModal");
