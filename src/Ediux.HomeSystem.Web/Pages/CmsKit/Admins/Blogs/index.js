...
$(function () {
    ...
    var createModal = new abp.ModalManager({ viewUrl: abp.appPath + "CmsKit/Admins/Blogs/CreateModal", modalClass: 'createBlog' });
    var updateModal = new abp.ModalManager({ viewUrl: abp.appPath + "CmsKit/Admins/Blogs/UpdateModal", modalClass: 'updateBlog' });
    var featuresModal = new abp.ModalManager(abp.appPath + "CmsKit/Admins/Blogs/FeaturesModal");
