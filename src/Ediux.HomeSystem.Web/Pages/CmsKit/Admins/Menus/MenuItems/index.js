...
$(function () {
    ...
    var createModal = new abp.ModalManager({ viewUrl: abp.appPath + 'CmsKit/Admins/Menus/MenuItems/CreateModal', modalClass: 'createMenuItem' });
    var updateModal = new abp.ModalManager({ viewUrl: abp.appPath + 'CmsKit/Admins/Menus/MenuItems/UpdateModal', modalClass: 'updateMenuItem'});
