...
namespace Ediux.HomeSystem.Migrations
{
    ...
    [Migration("20211112122533_change-userid-can-be-null")]
    partial class changeuseridcanbenull
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ediux.HomeSystem.Data.AbpPlugins", b =>
                {
                    b.Property<Guid>("Id")
                    ...
                    b.ToTable("AppPlugins");
                });

            modelBuilder.Entity("Ediux.HomeSystem.Data.ComponentsRegistration", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("AllowUserSetting")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("Ediux.HomeSystem.Data.DashboardWidgets", b =>
                {
                    ...
                    b.ToTable("App_DashboardWidgets");
                });
            ...
            modelBuilder.Entity("Ediux.HomeSystem.Data.File_Store", b =>
                {
                    ...
                    b.Property<string>("SMBFullPath")
                        .HasMaxLength(2048)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(2048)");

                    b.Property<string>("SMBLoginId")
                        .HasMaxLength(50)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("SMBPassword")
                        .HasMaxLength(2048)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(2048)");
                    ...
                    b.ToTable("App_File_Store");
                });

            modelBuilder.Entity("Ediux.HomeSystem.Data.GCMUserTokenMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("App_GCMUserTokenMapping");
                });
            ...
            modelBuilder.Entity("Ediux.HomeSystem.Data.MIMEType", b =>
                {
                    ...
                    b.ToTable("App_MIMETypes");
                });

            modelBuilder.Entity("Ediux.HomeSystem.Data.PersonalCalendar", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("t_end")
                        .HasMaxLength(20)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(20)");

                    b.Property<string>("t_start")
                        .HasMaxLength(20)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.ToTable("App_Calendars");
                });

            modelBuilder.Entity("Ediux.HomeSystem.Data.ProductKeys", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("App_ProductKeys");
                });

            modelBuilder.Entity("Ediux.HomeSystem.Data.UserPasswordStore", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("ReservedField1")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ReservedField2")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ReservedField3")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ReservedField4")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ReservedField5")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ReservedFieldName1")
                        .HasMaxLength(256)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ReservedFieldName2")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ReservedFieldName3")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ReservedFieldName4")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");

                    b.Property<string>("ReservedFieldName5")
                        .HasMaxLength(256)
                        .HasColumnType("nvarchar(256)");
                    ...
                    b.ToTable("App_UserPasswordStore");
                });
