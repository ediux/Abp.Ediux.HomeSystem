...
{
    public class SmartAdminUIWebHostMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public SmartAdminUIWebHostMenuContributor(IConfiguration configuration)
        {
        ...
        {
            var l = context.GetLocalizer<SmartAdminUIResource>();
